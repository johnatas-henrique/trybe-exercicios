...
function CardList() {
  return (
    <div className="row">
      ...
      <div className="col-sm-4">
        <Card
          featureImage="https://static.xx.fbcdn.net/rsrc.php/v3/yi/r/OBaVg52wtTZ.png"
          title="Teste"
          description="Crie a tag que você quiser #1"
          link="https://johnatas-henrique.github.io/projetos/facebook-signup/"
        />
      </div>
      <div className="col-sm-4">
        <Card
          featureImage="https://johnatas-henrique.github.io/projetos/daily-prophet/imagens/logo-cleanup.svg"
          title="Teste"
          description="Crie a tag que você quiser #2"
          link="https://johnatas-henrique.github.io/projetos/daily-prophet/"
        />
      </div>
    </div>
  );
